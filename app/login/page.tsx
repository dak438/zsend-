  ...
  return (
    <div className="relative min-h-screen bg-canvas flex items-center justify-center overflow-hidden px-4">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(99,102,241,0.18) 0%, rgba(139,92,246,0.08) 40%, transparent 70%)',
        }}
      />
      <div
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2.5 mb-8">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-accent-indigo to-accent-violet flex items-center justify-center shadow-lg shadow-indigo-500/25">
        ...
        <div className="glass-card p-8 sm:p-9 border border-white/10 shadow-2xl rounded-[2rem]">
          <div className="text-center mb-8">
            ...
            <p className="text-text-secondary text-sm max-w-xs mx-auto">
              Sign in with your verified Google account to check character status.
            </p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3.5 px-5 rounded-2xl border border-white/10 bg-surface-elevated hover:bg-surface hover:border-accent-indigo/60 text-text-primary text-sm font-semibold transition-all duration-200 shadow-md group disabled:opacity-50"
          >
            {loading ? (
          ...
          <div className="mt-8 pt-6 border-t border-white/5 space-y-2 text-center">
            <div className="flex items-center justify-center gap-1.5 text-xs text-text-muted font-mono">
              ...
              <span>Google OAuth 2.0 &middot; Verified Emails Only</span>
            </div>
            <p className="text-[11px] text-text-muted">
              No passwords stored. Your account is secured by Google authentication.
            </p>
          </div>
        </div>

        <p className="mt-6 text-center text-xs text-text-muted font-mono">
          ASCEND v2.0 // HONOR MODE // NO STAT DECAY
        </p>
      </motion.div>
    </div>
  );
